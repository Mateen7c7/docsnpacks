...
import { 
  Ship, Plane, Truck, Warehouse, 
  FileCheck, Clock, Globe, ArrowRight, CheckCircle,
  Phone, Mail
} from 'lucide-react';
...
const services = [
  {
    ...
    description: 'Global shipping solutions via sea and air with FCL, LCL, and charter services.',
    image: '/images/sea-freight.jpg',
  },
  {
    icon: Plane,
    title: 'Air Freight',
    description: 'Express air cargo services with Tier-1 carriers for time-critical shipments.',
    image: '/images/air-freight.jpg',
  },
  {
    icon: Truck,
    title: 'Road Transportation',
    description: 'Pan-India transportation with flatbed, low-bed trailers and GPS-enabled trucks.',
    image: '/images/road-transport.jpg',
  },
  {
    icon: Warehouse,
    title: 'Warehousing & 3PL',
    description: 'Modern warehousing facilities with complete 3PL and distribution services.',
    image: '/images/warehousing.jpg',
  },
];

const features = [
  { icon: Globe, title: 'Global Network', desc: 'Operations across India and worldwide' },
  { icon: Clock, title: 'On-Time Delivery', desc: '99% on-time shipment success rate' },
  { icon: FileCheck, title: 'Expert Documentation', desc: 'End-to-end customs documentation' },
  { icon: CheckCircle, title: 'Trusted Partner', desc: 'Serving since 2019 with excellence' },
];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center pt-28">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-300 text-lg mb-8 leading-relaxed animate-fade-in-up delay-200">
              Docs N Packs is a leading Freight Forwarding & Customs Clearance company 
              based in Hyderabad, serving clients across India and worldwide since 2019.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up delay-300">
              <Link to="/contact">
                <Button size="lg" className="bg-brand-blue hover:bg-brand-blue/90 text-white font-semibold px-8 py-6 text-base">
                  Get a Quote
            ...
            <div className="flex flex-wrap gap-6 mt-10 animate-fade-in-up delay-400">
              <a href="tel:+919100753313" className="flex items-center gap-2 text-gray-300 hover:text-brand-blue transition-colors">
                <Phone className="w-5 h-5" />
                <span>+91 91007 53313</span>
              </a>
              <a href="mailto:info@docsnpacks.com" className="flex items-center gap-2 text-gray-300 hover:text-brand-blue transition-colors">
        ...
        {/* Stats Bar */}
        <div className="absolute bottom-0 left-0 right-0 bg-brand-black/80 backdrop-blur-sm border-t border-white/10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-brand-gray mb-8 leading-relaxed">
                With over 5 years of experience in the logistics industry, Docs N Packs 
                has established itself as a trusted partner for businesses across India. 
              ...
              <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-xl p-6 max-w-xs">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-brand-gray text-sm">On-Time Delivery</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Get in touch with our logistics experts today for a free quote. 
              We provide customized solutions for all your shipping needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/contact">
                <Button size="lg" className="bg-brand-blue hover:bg-brand-blue/90 text-white font-semibold px-8 py-6">
                  Request a Quote
                  <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
              </Link>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Hyderabad (HQ)', 'Chennai', 'Delhi', 'Mumbai', 'Vizag', 'Pune', 'Bangalore'].map((city, index) => (
              <div 
                key={index}
